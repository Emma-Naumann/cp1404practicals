...
def format_phrase_to_sentence(phrase):
    """Reformat a phrase into a sentence, starting with a capital and ending with a full stop."""
...
assert format_phrase_to_sentence('i like books.') == 'I like books.'
