...
greater_than_nine_numbers = [number for number in numbers if number > 9]
print(greater_than_nine_numbers)
...
print(", ".join([name.split()[1][0:] for name in full_names if len(name) > 11]))
